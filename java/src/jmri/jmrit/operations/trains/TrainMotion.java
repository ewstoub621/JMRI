...
public class TrainMotion implements Serializable {
    static TrainMotion getFinalTrainMotion(List<TrainMotion> trainMotions) { return trainMotions.get(trainMotions.size() - 1); }
    ...
    static String getMotionsHeader() {
        return String.format(
                "%12s,%9s,%9s,%7s,%13s,%8s,%9s,%9s,%7s,%14s" +
                        "\n%12s,%9s,%9s,%7s,%13s,%8s,%9s,%9s,%7s,%14s",
                "delta time", "time", "distance", "speed", "acceleration", "force", "power", "throttle", "brake", "motion",
                "HH:MM:SS.SSS", "HH:MM:SS", "miles", "mph", "mph/s", "tons", "HP", "%", "%", "description"
        );
    }

    static String getRawMotionsHeader() {
        return String.format("%21s,%21s,%21s,%21s,%21s,%21s,%21s,%21s,%21s,%21s", "delta time", "time", "miles", "mph", "mph/s", "force", "power", "throttle", "brake", "description");
    }
    ...
    public TrainMotion(double dt, double t, double x, double v, double a, double f, double p, double tp, double bp, String d) {
        this.dt = dt;
        this.t = t;
        this.x = x;
        this.v = v;
    ...
    public String getMotionData() {
        return String.format(
                "%12s,%9s,%9.4f,%7.3f,%13.3f,%8.2f,%9.1f,%9.1f,%7.1f,%14s",
                timeString_12_Char(dt), timeString_8_Char(t), x, v, a, f, p, tp, bp, d);
    }

    public String getRawMotionData() {
        return String.format("%21s,%21s,%21s,%21s,%21s,%21s,%21s,%21s,%21s,%21s", dt, t, x, v, a, f, p, tp, bp, d);
    }
